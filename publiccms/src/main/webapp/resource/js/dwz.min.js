...
var navTab = {
    ...
    _currentIndex: 0 ,
    _op: {
        id: "navTab", step: 3 , stTabBox: ".navTab-tab", stPanelBox: ".navTab-panel", mainTabId: "main", close$: "a.close", prevClass: "tabsLeft", nextClass: "tabsRight" ,
                ...
                switch (field.type) {
                    ...
                    case 'date':
                        html = '<input type="text" name="' + field.name + '" value="' + field.defaultVal + '" class="date ' + field.fieldClass + '" dateFmt="' + field.patternDate
                                + '" size="' + field.size + '" ' + attrFrag + '/>' + '<a class="inputDateButton" href="javascript:void(0)"></a>';
                        break;
                    case 'checkbox':
